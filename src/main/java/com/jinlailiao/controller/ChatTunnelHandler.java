...
/**
 * Created by Yang Longxiang on 2018/7/27 027.
 */
...
public class ChatTunnelHandler implements TunnelHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ChatTunnelHandler.class);
    ...
    public void onTunnelConnect(Tunnel tunnel) {
        logger.info("调用onTunnelConnect方法");
        if (userMap.containsKey(tunnel.getTunnelId())) {
            ...
            logger.info("peopleMessage为" + peopleMessage.toString());
